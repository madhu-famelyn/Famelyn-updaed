        ...
        <div className="courses-container">
          ...
          <div className="course-card-centered">
            <div className="course-card-header">
              <img src={courseCover} alt="LinkedIn Profile Authority & Brand Building" className="course-cover-img" />
            ...
            <div className="course-card-body">
              {!showForm && !success ? (
                ...
                <div className="course-details-section-view">
                  <h2 className="course-main-title">Enhancing Your LinkedIn Profile</h2>
                  <h3 className="course-main-tagline">Build Your Brand. Unlock Opportunities.</h3>
                  <p className="course-main-text">
                    Join us for an exclusive LinkedIn Personal Branding Session designed to help professionals build a strong professional presence, increase visibility, and unlock new career and business opportunities.
                  </p>
                  <div className="duration-info" style={{ marginBottom: "25px" }}>
                    <span className="duration-label">⏱ Duration:</span> <strong>1 Hour</strong>
                  </div>
                  <button
                  ...
                  <form onSubmit={handleSubmit} className="registration-form" style={{ marginTop: "15px" }}>
                    ...
                    <div className="form-group">
                      ...
                      <div className="radio-options">
                        <div
                          className={`slot-option-card ${formData.selected_slot === "1st July | 3:00 PM | Gowra Deccan." ? "selected" : ""}`}
                          onClick={() => handleSlotClick("1st July | 3:00 PM | Gowra Deccan.")}
                        >
                          <div className="slot-check-circle"></div>
                          <span>1st July | 3:00 PM | Gowra Deccan.</span>
                        </div>
                        <div
                          className={`slot-option-card ${formData.selected_slot === "4th July | 11:00 AM | Online Session" ? "selected" : ""}`}
                          onClick={() => handleSlotClick("4th July | 11:00 AM | Online Session")}
                        >
                          <div className="slot-check-circle"></div>
                          <span>4th July | 11:00 AM | Online Session</span>
                        </div>
                      </div>
                    </div>
